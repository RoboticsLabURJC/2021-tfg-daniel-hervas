...
class RescuePeople():
    ...
    def __init__(self):
        ...
        cfg = config.load("rescue_people_conf.yml")
        ...
        print "Rescue People Component initialized OK"

    def play(self):
        # self.unpause_physics_client()
        self.algorithm.play()
        print "Rescue People is running"
        
    def pause (self):
        self.algorithm.pause()
        #self.pause_physics_client()
        print "Rescue People has been paused"
         
    def stop(self):
        self.algorithm.stop()
        print "Rescue People stopped"
