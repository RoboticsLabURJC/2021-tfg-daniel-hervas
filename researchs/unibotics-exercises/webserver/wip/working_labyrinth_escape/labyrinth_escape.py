...
class LabyrinthEscape():
    ...
    def __init__(self):
        cfg = config.load("labyrinth_escape_conf.yml")
        ...
        print "Labyrinth Escape Component initialized OK"

    def play(self):
        # self.unpause_physics_client()
        self.algorithm.play()
        print "Labyrinth Escape is running"
        
    def pause (self):
        self.algorithm.pause()
        #self.pause_physics_client()
        print "Labyrinth Escape has been paused"
         
    def stop(self):
        self.algorithm.stop()
        print "Labyrinth Escape stopped"
