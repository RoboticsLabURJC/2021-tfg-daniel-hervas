...
class Grid:
    ...
    def __init__(self):
        ...
        self.map = Map(self)
        self.gWidth = int(self.map.width)
        self.gHeight = int(self.map.height)
        self.wWidth = float(self.map.worldWidth)
        self.wHeight = float(self.map.worldHeight)
        self.origX = self.map.originX
        self.origY = self.map.originY
        self.mapAngle = self.map.mapAngle

        self.grid = np.zeros([self.gWidth, self.gHeight], float)
