...
class PublisherMotors:
    ...
    def __init__(self, topic, maxV, maxW, nodename):
...
class RaceMultiplayer():
    ...
    def __init__(self,cfgfile='local_race_multiplayer.yml',nodename='RaceMultiplayerF1'):
        ...
        self.motors = PublisherMotors(motorsTopic, maxv, maxw, nodename)

        self.algorithm=MyAlgorithm(self.camera, self.motors)
        rospy.Subscriber("startOrder", String, self.coordination)

        print "Race_Multiplayer Components initialized OK"
    
    def coordination(self, data):
        if data.data == "START":
            self.play()
    ...
    def play(self):
        ...
        self.algorithm.play()
        #self.referee_start()
        print "Race_Multiplayer is running"
        
    def pause (self):
        self.algorithm.pause()
        #self.pause_physics_client()
        print "Race_Multiplayer has been paused"
         
    def stop(self):
        self.algorithm.stop()
        #self.referee_stop()
        print "Race_Multiplayer stopped"
