...
De igual manera que en el juego \emph{Follow Line}, primeramente hay que realizar la conexión con el RADI. Posteriormente, puede elegirse la dificultad del ratón, cargar el código del usuario, y reanudar la simulación.
