...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",qa:"No has iniciado sesi\u00f3n"},{G:"div",L:"ytp-mdx-popup-description",qa:"Los v\u00eddeos que veas podr\u00edan aparecer en el historial de reproducciones de la TV e influir en las recomendaciones. Puedes evitarlo si cancelas e inicias sesi\u00f3n en YouTube desde tu ordenador."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-cancel"],
qa:"Cancelar"},{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-confirm"],qa:"Confirmar"}]}]}]});this.j=new g.GJ(this,250);this.cancelButton=this.Da("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Da("ytp-mdx-privacy-popup-confirm");g.J(this,this.j);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},N9=function(a){g.V.call(this,{G:"div",
...
b=g.U(b,128)?g.tG("No se ha podido reproducir el v\u00eddeo en $RECEIVER_NAME",c):b.Jc()||g.U(b,4)?g.tG("El v\u00eddeo se est\u00e1 reproduciendo en $RECEIVER_NAME",c):g.tG("Conectado a $RECEIVER_NAME",c);a.Ma("statustext",b);a.j.show()}else a.j.hide()},O9=function(a,b){g.zP.call(this,"Reproducir en",0,a,b);
...
O9.prototype.Bj=function(a){return"cast-selector-receiver"===a?"Enviar...":this.hp[a].name};
